...
public class ProductAttributes implements java.io.Serializable {
	...
	public ProductAttributes(int id, Date createdAt, Date updatedAt) {
		this.id = id;
		this.createdAt = createdAt;
		this.updatedAt = updatedAt;
	}

	public ProductAttributes(int id, String name, Date createdAt, Date updatedAt,
			Set<ProductVariants> productVariantses) {
		this.id = id;
		this.name = name;
		this.createdAt = createdAt;
		this.updatedAt = updatedAt;
