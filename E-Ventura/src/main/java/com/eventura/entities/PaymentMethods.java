...
public class PaymentMethods implements java.io.Serializable {
	...
	public PaymentMethods(String name, Date createdAt, Date updatedAt) {
		this.name = name;
		this.createdAt = createdAt;
		this.updatedAt = updatedAt;
	}

	public PaymentMethods(String name, Date createdAt, Date updatedAt, Set<Payments> paymentses) {
		this.name = name;
		this.createdAt = createdAt;
		this.updatedAt = updatedAt;
